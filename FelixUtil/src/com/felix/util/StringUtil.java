...
public class StringUtil {
	 ...
	 * 
	 * @param s
	 *            The String with whitespace separated substrings.
	...
	/**
	 * Return the newline separated tokens of a string.
	 * 
	 * @param s
	 *            The String with whitespace separated substrings.
	 * @return THe return Vector.
	 */
	public static Vector<String> stringToVectorNewlineSeparated(String s) {
		Vector<String> ret = new Vector<String>();
		StringTokenizer st = new StringTokenizer(s, "\n");
		while (st.hasMoreTokens()) {
			ret.add(st.nextToken());
	...
	/**
	 * Test if two strings are equal except of occurring whitespace
	 * 
	 * @param a
	 *            e.g. "bla blubb "
	 * @param b
	 ...
	 * @return e.g. true.
	 */
	public static boolean isStringEqualExceptWhitespace(String a, String b) {
		String aw = a.replaceAll("\\s", "");
		String bw = a.replaceAll("\\s", "");
		return aw.compareTo(bw) == 0;
	}

	/**
	 * Return a vector containing all whitespace separated substrings that are
	 * in string a but not in string b.
	 * 
	 * @param a
	 *            The a string, e.g. "a b c"
	 * @param b
	 *            The b string, e.g. "b"
	 * @return The result, e.g. "a b"
	 */
	public static Vector<String> getStringsNotContained(String a, String b) {
		Vector<String> ret = new Vector<String>();
		String[] aa = stringToArray(a);
		String[] ab = stringToArray(b);
		for (int i = 0; i < aa.length; i++) {
			String string = aa[i];
			if (!isStringInArray(string, ab)) {
				ret.add(string);
			}
		}
		return ret;
	 ...
	 * @return The result, e.g. "a b"
	 */
	public static String getStringsNotContainedString(String a, String b) {
		String ret = "";
		String[] aa = stringToArray(a);
		String[] ab = stringToArray(b);
		for (int i = 0; i < aa.length; i++) {
	 ...
	 * 
	 * @param strings
	 *            The Vector with String with whitespace separated substrings.
	 * @return THe return Vector.
	 */
	public static Vector<String> stringsToVector(Vector<String> strings) {
		Vector<String> ret = new Vector<String>();
	...
	/**
	 * Try to find two letters that describe umlauts and replace them
	 * 
	 * @param in
	 *            , e.g. Aepfel
	 * @return out, e.g Äpfel
	 */
	public static String doubleLetterToUmlaut(String in) {
		String result = in;
	 ...
	 */
	public static String removeNonAlphanumericCharacters(String in) {
...
/*		in = in.replace("-", " ");*/
	...
	/**
	 * Add whitespace separated words to Vector.
	 * 
	 * @param s
	 * @param addable
	 */
	public static void addWordsToVector(String s, Vector<String> addable) {
		StringTokenizer st = new StringTokenizer(s);
		while (st.hasMoreTokens()) {
			addable.addElement(st.nextToken());
		}
	}
	...
	/**
	 * Combine two string arrays so that all strings appear only once in the
	 * result array.
	 * 
	 * @param array1
	 *            The first array.
	 ...
	 */
	public static String[] unifyStringArrays(String[] array1, String[] array2) {
		Vector tmp = new Vector<String>();
		for (String s : array1) {
			tmp.add(s);
		}
		for (String s : array2) {
			if (!isStringInArray(s, array1))
				tmp.add(s);
		}
		return vectorToStringArray(tmp);
	}
	...
	/**
	 * Return all strings that contain whitespace
	 * 
	 * @param in
	 * @return
	 */
	public static Vector<String> getMultiwords(Vector<String> in) {
		Vector<String> multiWords = new Vector<String>();
		for (Iterator iterator = in.iterator(); iterator.hasNext();) {
			String string = (String) iterator.next();
			if (string.indexOf("\\s") > 0) {
				multiWords.add(string);
			}
		}
		return multiWords;
	 ...
	 * @param msg
	 */
	public static void printOutVector(Vector<String> vec) {
		for (String s : vec) {
			printOut(s);
			;
		}
