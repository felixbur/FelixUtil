...
public class FileUtil {
	 ...
	 * @throws Exception
	 */
	public static void writeFileContent(OutputStream out, String content,
			String charEncoding) throws Exception {
		BufferedWriter bw = null;
		try {
			bw = new BufferedWriter(new OutputStreamWriter(out, charEncoding));
			bw.write(content);
		} catch (Exception e) {
			System.err.println("error trying to get file content"
					+ e.toString());
	 ...
	 * @throws Exception
	 */
	public static void writeFileContent(String fileName, InputStream inputStream)
			throws Exception {
		byte buf[] = new byte[1024];
		int len;
